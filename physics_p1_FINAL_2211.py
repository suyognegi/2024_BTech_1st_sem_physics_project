            ...
            if option == "Theta":
                ...
                while True:
                    ...
                    if ok:
                        ...
                        break  # Exit the loop if the user cancels the input
            ...
            if option == "Theta":
                while True:
                    ...
                    if ok:
                        try:
                            theta = float(data)
                            if theta % 90 == 0 and theta % 180 != 0:  # Avoid undefined tan values
            ...
            if option == "Theta":
                while True:  # Loop until a valid theta is provided
                    ...
                    if ok:
                        try:
                            theta = float(data)
                            if theta % 180 == 0:  # Check if Theta is a multiple of 180
                ...
                while True:
                    ...
                    if ok:
                        try:
                            value = float(data)
                            if value != 0:  # Validate that the value is not zero
                                print(f"Value: {value}")
            ...
            if option == "Theta":
                while True:
                    ...
                    if ok:
                        try:
                            theta = float(data)
                            if theta % 90 == 0 and theta % 180 != 0:  # Avoid undefined sec values
            ...
            if option == "Theta":
                while True:
                    ...
                    if ok:
                        try:
                            theta = float(data)
                            if theta % 180 == 0:  # Avoid undefined cot values
